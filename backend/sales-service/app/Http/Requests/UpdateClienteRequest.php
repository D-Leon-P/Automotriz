    ...
    public function rules()
    {
        ...
        return [
            ...
            'email' => [
                ...
                'email',
                'max:100',
                \Illuminate\Validation\Rule::unique('clientes', 'email')->ignore($id)->whereNull('deleted_at')
            ],
            ...
            'documento' => [
                ...
                'string',
                'max:20',
                \Illuminate\Validation\Rule::unique('clientes', 'documento')->ignore($id)->whereNull('deleted_at')
            ],
